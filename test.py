...
#             rook.valid_moves(0, 0, 2, 2)  # Movimiento inválido (no es en línea recta)
    
#     def test_valid_bishop_movement(self):
#         """Prueba los movimientos válidos del alfil"""
#         bishop = Bishop("white")
#         board = Board()
#         self.assertTrue(bishop.valid_moves(0, 0, 2, 2))  # Movimiento diagonal
...
#         board = Board()
#         with self.assertRaises(InvalidMove):
#             bishop.valid_moves(0, 0, 0, 2)  # Movimiento inválido (no es diagonal)
...
# # Clase de pruebas para la función suma (si es necesario)
# class TestSum(unittest.TestCase):
#     def test_sum(self):
#         self.assertEqual(suma(1, 2), 3)
...
#     rook = Rook("white")
#     board = Board()
#     with self.assertRaises(InvalidMoveVerticalHorizontal):  # Cambia aquí
#         rook.valid_moves(0, 0, 2, 2, board)  # Movimiento inválido (no es en línea recta)
